...
export default function RegisterPage() {
    ...
    const [LabNameFocus, setLabNameFocus] = React.useState(false);
    const [LabAddressFocus, setLabAddressFocus] = React.useState(false);
    React.useEffect(() => {
                                            ...
                                            <Form className="form">
                                                <InputGroup
                                                    className={classnames({
                                                        "input-group-focus": LabNameFocus,
                                                    })}
                                                >
                                                    ...
                                                    <Input
                                                        ...
                                                        onFocus={(e) => setLabNameFocus(true)}
                                                        onBlur={(e) => setLabNameFocus(false)}
                                                    />
                                                </InputGroup>
                                                <InputGroup
                                                    className={classnames({
                                                ...
                                                <InputGroup
                                                    className={classnames({
                                                        "input-group-focus": LabAddressFocus,
                                                    })}
                                                >
                                                    <InputGroupAddon addonType="prepend">
                                                        <InputGroupText>
                                                    ...
                                                    <Input
                                                        ...
                                                        onFocus={(e) => setLabAddressFocus(true)}
                                                        onBlur={(e) => setLabAddressFocus(false)}
                                                    />
                                                </InputGroup>
                                                <InputGroup
                                                    className={classnames({
